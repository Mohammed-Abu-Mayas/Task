<nav
    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-container content" style="background-color: #fbac2b !important;">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">
                  <span
                      class="user-name text-bold-700"> Hello <?php echo e(Auth::user()->name); ?></span>
                </span>
                            <span class="avatar avatar-online">
                  <img  style="height: 35px;" src="<?php echo e(asset('img/me.jpg')); ?>" alt="avatar"><i></i></span>
                        </a>
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="<?php echo e(asset('assets/admin/images/portrait/small/avatar-s-19.png')); ?>"
                               alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                        ...
                        <span class="avatar avatar-sm avatar-busy rounded-circle">
                          <img src="<?php echo e(asset('assets/admin/images/portrait/small/avatar-s-2.png')); ?>" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="<?php echo e(asset('assets/admin/images/portrait/small/avatar-s-3.png')); ?>" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                        ...
                        <span class="avatar avatar-sm avatar-away rounded-circle">
                          <img src="<?php echo e(asset('assets/admin/images/portrait/small/avatar-s-6.png')); ?>" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
...
</nav><?php /**PATH C:\xampp\htdocs\lezzoo_task\resources\views/admin/includes/header.blade.php ENDPATH**/ ?>